...
7. **Database Migration**: Use alembic for db migration
8. **Testing**: Test all layers independently
9. **Package management**: Use uv for package managing
10. **Micro service**: Deploy with docker compose
